        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            <FormControl fullWidth>
              ...
              <Select value={formData.ikon} onChange={handleChange('ikon')} label="İkon">
              ...
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                {colorOptions.map(color => (
                  <Tooltip key={color} title={color}>
                    <IconButton
                      onClick={() => setFormData(prev => ({ ...prev, renk: color }))}
                      sx={{
                        width: 32,
                        height: 32,
                        bgcolor: color,
                        border: formData.renk === color ? '3px solid #000' : '1px solid #ccc',
                        '&:hover': {
                          bgcolor: color,
                          opacity: 0.8,
                        },
          ...
          <Grid item xs={12}>
            <FormControl fullWidth>
              ...
              <Select value={formData.aktif} onChange={handleChange('aktif')} label="Durum">
