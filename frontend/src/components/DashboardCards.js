            ...
            <Card>
              <CardContent>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                  <Box
                    sx={{ width: 40, height: 40, bgcolor: 'grey.300', borderRadius: 1, mr: 2 }}
                  />
                  <Box sx={{ flex: 1 }}>
                    <Box
                      sx={{ width: '60%', height: 16, bgcolor: 'grey.300', borderRadius: 1, mb: 1 }}
                    />
          ...
          <CardContent>
            ...
            {dashboard?.durumStats?.map(stat => (
              <Box key={stat._id} sx={{ mb: 2 }}>
                ...
                <LinearProgress
                  variant="determinate"
                  value={(stat.count / (dashboard?.genel?.toplamEnvanter || 1)) * 100}
          ...
          <CardContent>
            ...
            <Grid container spacing={2}>
              ...
              {categories.length === 0 && (
                <Grid item xs={12}>
                  <Alert severity="info">
                    Henüz kategori oluşturulmamış. Başlamak için "Yeni Kategori" butonuna tıklayın.
                  </Alert>
                </Grid>
              )}
            </Grid>
